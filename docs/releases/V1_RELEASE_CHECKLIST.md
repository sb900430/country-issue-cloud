...
| Three-country fixture TOP5 | PASS | 120 articles per country, five keywords, related links |
...
- 공개 URL에서 세 국가, TOP5, layout 전환, 상세 관련 기사 흐름이 동작해야 한다.
...
- 公開URLで3か国、TOP5、layout切替、詳細関連記事flowが動作すること。
