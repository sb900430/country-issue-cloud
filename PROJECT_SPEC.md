...
1인 개발, 주 10~15시간 기준 10주 계획이다. 신규 개인 Play 계정에 비공개 테스트 의무가 적용되는 경우 최소 요구 기간을 충족한 뒤 프로덕션 출시를 신청한다.

### 1주차 — 설계와 기반

- [ ] 요구사항, 데이터, 와이어프레임 확정
- [ ] 아키텍처와 ADR
- [ ] monorepo와 Python/Android CI
- [ ] 샘플 JSON과 fixture

완료 기준: 문서 리뷰, 빈 프로젝트 빌드와 CI 성공
...
- [ ] Compose, 국가/날짜 탭, 클라우드, 상세
- [ ] 네트워크 Repository와 Room
- [ ] 로딩, 오류, 부분 성공, 오프라인

완료 기준: 실제 API로 핵심 사용자 흐름 동작

### 7주차 — 운영 배포

- [ ] VPS, nginx, TLS, systemd
- [ ] GitHub Actions 배포
- [ ] health/ready와 로그
- [ ] 7일 연속 자동 실행 관찰 시작

완료 기준: 외부에서 앱·웹·API 동작

### 8주차 — Play 준비

- [ ] 아이콘, 스크린샷, 스토어 문구
- [ ] 개인정보처리방침, 문의, Data Safety
- [ ] release 서명/AAB와 내부 테스트
- [ ] 요구되는 비공개 테스트 시작

완료 기준: Play 테스트 트랙 설치
...
- [ ] 접근성, 오프라인, 장애 시나리오 수정
- [ ] 운영 배치와 비용 추이 검토
- [ ] 스토어 설명과 Data Safety 최종 대조

완료 기준: 요구되는 비공개 테스트 기간과 참여 조건 충족 또는 충족 일정 확정

### 10주차 — 출시와 포트폴리오

- [ ] 비공개 테스트 최종 피드백 반영
- [ ] README, 다이어그램, 데모 이미지, 런북
- [ ] `v1.0.0`과 GitHub Release
- [ ] 단계적 프로덕션 배포 신청과 회고

완료 기준: Play 상태/링크, Live Demo, 공개 GitHub 제공
